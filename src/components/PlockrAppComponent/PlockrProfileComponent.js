            ...
            <div className='container-fluid'>
                <div className='row'>
                    ...
                    <div className='col-sm-6'>
                        <div className='row'>
                            <div className='col'>
                                <a href='/plockrapp'>Back</a>
                            </div>
                            <div className='col'>
                                <button type="button" class="btn btn-primary-outline" onClick = {this.handleLogout}>Log out</button>
                            </div>
                        </div>
                        <div className='row'>
                        ...
                        <form onSubmit={this.handleSubmit}>
                            ...
                            <button type="button" class="btn btn-primary-outline">Log out</button>
                        </form>
                    </div>
                    <div className='col-sm-3'>
                    </div>
