...
class MentalhealthComponent extends Component {
    render() {
        return (
            <div>
            <div className='container-fluid'>
                ...
                <div className="container-fluid dental-margin">
                    ...
                    <h1 className="key-benefits">Seeking Mental Health with Professional Guidance</h1>
                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-6">
                            <p className="dental-problem">Mental health is often neglected and hidden for reasons like fear of rejection from society or lack of understanding. However, at <a className="tag-color" href="/">Plunes </a>we help or users in finding the best psychologist in Gurgaon. We have a strict policy regarding the privacy and confidentiality of our users. Our advanced AI helps you in connecting with the best<a className="tag-color" href="physiotherapy"> psychotherapist in Gurgaon</a> at the most affordable rates.   
                             </p><br></br>
                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-10">
                            ...
                            <p className="tooth-decay-font">at times it is observed that an individual does not behave as per the appropriate age and thus needs therapy for this<a className="tag-color" href="how-to-get-a-healthy-mind"> mental disorder.</a></p>
                            <br></br>
                            ...
                            <p className="tooth-decay-font">it is a deliberate effort to sleep with the help of different techniques and lengthen the period of sleep along with its effectiveness to reduce or present the ill effects of poor quality of sleep.
Mental health is important and needs immediate attention for the well-being of the person. </p>

                            <p className="tooth-decay-font">Even people in their adolescent years need help to understand their behaviour, feelings, change in their bodies and much more. It requires that someone talks to them and ask them to express their feelings. All these counselling helps people to express their feelings and rejuvenate themselves.
                               <br/> <br/>We empathize with the users who are in need of help and in real time we help them in getting the required help. There are no questions asked or any judgment made. Thus the users feel comfortable and can reach out to us for seeking help.
</p>
