          ...
          <div className="container-fluid">
            <div class="row">
              ...
              <div className="col-sm-2 ">
                ...
                <ul className="follow-us-at">
                  <h3 class="ftr3 footerfont">FOLLOW US AT </h3>
                  <li className="follow-us-at">
                    <span>
                      <a href="https://in.linkedin.com/company/plunes-com/" target="_blank" title="linkedin"><img className="ftr" src="/linkedin.png" alt=".." /></a></span>
                  </li>
                  <li className="follow-us-at">
                    <span>
                      <a href="https://instagram.com/plunes_utility_network?igshid=17ov9733181re/" title="instagram" target="_blank"><img className="ftr1" src="/Instagram.png" alt=".." /></a></span>
                  </li>
                  <li className="follow-us-at">
                    <span>
                      <a href="https://www.facebook.com/plunes076/ " title="facebook" target="_blank"><img className="ftr2" src="/Facebook.png" alt=".." /></a></span>
                  </li>
                </ul>
              </div>
              <div class="col-sm-2 ">
