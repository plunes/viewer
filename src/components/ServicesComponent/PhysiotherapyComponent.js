...
<p className="header-font">1. Physiotherapist Consultation
...
<p className="header-font">7. Low level laser therapy </p>
<p className="peragraph-text">
...
<p className="header-font">8. High power laser therapy </p>
<p className="peragraph-text">
...
<div className="col-sm-3">
<p className="header-font">3. Interferential Therapy</p>
<p className="peragraph-text">
It is essentially a deeper form of TENS (Transcutaneous Electrical Nerve Stimulation).  It utilizes two high frequency currents which are slightly out of phase, and are passed through the skin at the same time where they are set up so that their paths cross and simply interfere with each other.
</p>
<br></br><br></br><br></br><br></br><br></br>
<p className="header-font">6. Laser Therapy</p>
<p className="peragraph-text">
...
<div className="col-sm-3">
<p className="header-font">11. Toweling / Bandaging Method:
</p>
<p className="peragraph-text">
...
. </p>
<br></br><br></br>
<p className="header-font">17. Long Wave Diathermy
</p>
