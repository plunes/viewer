                ...
                <div className='container-fluid blog-margin'>
                    ...
                    <div className="row">
                        ...
                        <div class="card card-blog" >
                                ...
                                <div class="card-body">
                                    <h3 class="card-title">Dental Complications To Consider For Healthy Suggestions</h3>
                        ...
                        <div class="card card-blog" >
                                ...
                                <div class="card-body">
                                    <h3 class="card-title">How Teeth Whitening Can Improve Your Lifestyle</h3>
                        ...
                        <div class="card card-blog" >
                                ...
                                <div class="card-body">
                                    <h3 class="card-title">Touch-up Your Dental Health with Root Canal Treatment</h3>
