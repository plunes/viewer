    ...
    render() {
        return (
            <div className='container-fluid'>
                ...
                <meta name='keywords' content='T&C, Terms, Personal Information, Member, policy, confidentiality, personal information, data, terms of use, privacy policy'></meta>
                <meta name="description" content="Plunes provides a platform to facilitate direct communication between a professional and a User defined under Terms of Use.">
                </meta>
                </Helmet>
                <div>
                    <LandingHeader />
                ...
                <div className='container-fluid'>
                    <div className='row justify-content-center'>
                        ...
                        <h1 className="ploker-header">TERMS OF USE FOR MEMBERS</h1>
                    </div>
                    <div className="row">
                        ...
                        <div className="col-sm-10">
                            ...
                            a - Medical Professional; or</p>
                            <p className="medical-text pharma-align">
                            b - Pharmaceutical Professional
                            </p>
                            <p className="terms-of">
                            (Cumulatively hereinafter referred to as “Members”).<br></br><br></br>
