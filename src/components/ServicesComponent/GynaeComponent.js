    ...
    render() {
        return (
                    ...
                    <div className="col-sm-11 header2-text">
                        <div className="row">
                            <div className="col-sm-2">
                                <img className="dentist-image" src="/Gynaecologist.png" />
                            </div>
            ...
            <p className="header-font">1. Gynecologist Consultation In Delhi NCR at best price:</p>
                        ...
                        <div className="col-sm-3">
                            <p className="header-font">2. Bartholins Cyst Treatment In Delhi NCR at best price: </p>
                            <p className="peragraph-text">
                        ...
                        <div className="col-sm-3">
                            <p className="header-font">3. Vulvar Biopsy In Delhi NCR at best price:</p>
                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-3">
                            <p className="header-font">8. Laparotomy In Delhi NCR at best price:</p>
                            <p className="peragraph-text">
                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-3">
                            <p className="header-font">11. Abdominal Myomectomy In Delhi NCR at best price:
</p>
                            <p className="peragraph-text">
