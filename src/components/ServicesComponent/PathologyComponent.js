...
<br></br>
                                        ...
                                        <div className="row">
                                                ...
                                                <div className="col-sm-3">
                                                        <p className="header-font">11. Thyroxin (T4) Test:
                                        ...
                                        <div className="row">
                                                ...
                                                <div className="col-sm-3">
                                                        <p className="header-font">17. Blood Urea Nitrogen (BUN) KFT Test:
...
. </p>
                                        ...
                                        <div className="row">
                                                ...
                                                <div className="col-sm-3">
                                                        <p className="header-font">22. Human Immuno Virus (HIV -1) Test:</p>
                                                        <p className="peragraph-text">
...
<br></br>
                                                ...
                                                <div className="col-sm-3">
                                                        <p className="header-font">23. Insulin (F) Test:
</p>
                                                        <p className="peragraph-text">
