                ...
                <div className="container-fluid dental-margin">
                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-10">
                            ...
                            <p className="tooth-decay-font">Downloading PLUNES will also include amazing perks & privileges specially devised for you -</p>
                            ...
                            <p className="tooth-decay-font">PLOCKR is India’s first cross-functional integrated platform for EMRs (Electronic Medical Records).  </p>
                            <br></br>
                            <h1 className="tooth-font">What PLOCKR do? </h1>

                            <p className="tooth-decay-font">Post diagnosis, the minimum waiting time is up-to 3-4 hours for the final doctor’s remarks and reports. One has to wait in the long queues to get the reports finally verified by the Doctor. By downloading PLUNES, you will get your reports instantly in your PLOCKR ID with Doctor’s remarks. It acts as an Intelligent Cloud Storage solution allowing you to get all your reports instantly with just one click.<br></br><br></br>
                                So long gone are the days of waiting in the line. Our AI will help you search instant solutions for all your medical procedures & treatments in Delhi NCR. <br></br><br></br>
                                Search for any medical procedures such as teeth whitening, MRI, X-Ray, sensitivity, dental implants, IVF or any other medical treatments & our AI will negotiate in real-time with top hospitals & clinics nearest to you.
