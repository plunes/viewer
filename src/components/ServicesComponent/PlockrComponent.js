                ...
                <div className='container-fluid'>
                    ...
                    <div className='row plockr-align'>
                        ...
                        <div className='col-sm-6 col'>
                            ...
                            <p className="EMR">
                                EMR stands for Electronic medical records, which are the digital equivalent of paper records, or charts at a clinician's office. EMRs contain general information such as treatment and medical history about a patient as it is collected by the individual medical practice.
                              </p>
                            <p className="EMR">
