            ...
            <div>
                ...
                <div className="continer-fluid">
                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-3">
                            <p className="header-font">4. Jaw Surgery:</p>
                            <p className="peragraph-text">
                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-3">
                            <p className="header-font">7. Spinal Fusion Surgery: </p>
                            <p className="peragraph-text">Spinal fusion is a surgical procedure used to correct problems with the small bones in the spine (vertebrae).
                        ...
                        <div className="col-sm-3">
                            <p className="header-font">9. Arthroplasty: </p>
                            <p className="peragraph-text">
                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-3">
                            <p className="header-font">11. Bone Grafting:
</p>
                            <p className="peragraph-text">
                        ...
                        <div className="col-sm-3">
                            <p className="header-font">12. Allograft Treatment:
</p>
                            <p className="peragraph-text">
